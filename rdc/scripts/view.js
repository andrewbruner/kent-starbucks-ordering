		...
		main.classList.add('container', 'mb-5');
			...
			form.addEventListener('submit', event => controller.handleSubmit(event));
				...
				data.forEach((item, index) => {
					...
					division.classList.add('input-group', 'input-group-sm');
					division.style.cursor = 'pointer';
						...
						span.classList.add('align-items-start', 'col-7', 'flex-column', 'input-group-text');
							...
							details.classList.add('d-flex', 'fw-l', 'justify-content-between', 'w-100');
								// uom
						...
						input.addEventListener('blur', (event) => {
							controller.handleFocusout(event, alertColor);
						});
						...
						amount.classList.add('col-2', 'input-group-text');
